<%@ Page Title="" Language="C#" MasterPageFile="~/UI/Admin/AdminSite.Master" AutoEventWireup="true" CodeBehind="home.aspx.cs" Inherits="SchoolSite.UI.Admin.home" %>
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder" runat="server">
    <section class="content-header">
        <div class="row">
            <div class="col-md-12" style="text-align: center;">
                <h2>T-Soft School Management System</h2>
            </div>
            <div class="col-md-12">
                <h1><small>Admin Control panel</small></h1>
                <ol class="breadcrumb">
